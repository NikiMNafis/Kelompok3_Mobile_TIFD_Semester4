...
import 'package:project_akhir_mobile_smtr4/models/message_model.dart';
...
import 'package:project_akhir_mobile_smtr4/services/message_service.dart';
      ...
      return ListView(
        ...
        children: [
          ...
          ChatBubble(
            isSender: false,
            text:
            'Hello, This item is only available in color Moonlight and Greylight',
          ),
        ],
      );
    }
